  ...
  return (
    <div className="min-h-screen bg-panel flex items-center">
      <div className="max-w-5xl mx-auto px-4 md:px-8 py-24">
        <p className="text-sm font-bold uppercase tracking-widest text-panel-accent mb-3">404</p>
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 bg-brand text-white font-semibold text-sm px-6 py-3 rounded-lg hover:bg-brand-hover transition-colors"
        >
          Back to home
        </Link>
      </div>
